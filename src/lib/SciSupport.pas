...
type
  ...
  TSCNotification = record
    nmhdr 		          : TNotifyHeader;
    position    	      : NativeInt;		// SCN_STYLENEEDED, SCN_MODIFIED
...
{$endif}
  ...
  PTextRange = ^RSciTextRange;
  RSciTextRange = Record
    chrg : RSciCharacterRange;
    lpstrText : LPSTR;
  end;
  PTextToFind = ^RSciTextToFind;
...
// https://github.com/notepad-plus-plus/notepad-plus-plus/commit/ed4bb1a93e763001aac842698fcde0856ba8b0bc
    ...
    KEYWORDSET_MAX = 30; // https://github.com/notepad-plus-plus/notepad-plus-plus/commit/a58e54bc68f7a042162d55c0c8e0c2ee1c4592fd
    ...
    SCI_GETBOOSTREGEXERRMSG = 5000; // https://github.com/notepad-plus-plus/notepad-plus-plus/commit/926e6e97d82b3d63103cb2297b372af5cd469ca6
